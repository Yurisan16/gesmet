...
function fnSelectAtoB(){
    ...
    var $selectB = $('#cliente-seleccionado');
    $('option:selected',$select).appendTo('#cliente-seleccionado');
...
function fnSelectBtoA(){
    ...
    var $selectA = $('#cliente-lista');
    $('option:selected',$select).appendTo('#cliente-lista');
    $('option:selected',$select).remove();
